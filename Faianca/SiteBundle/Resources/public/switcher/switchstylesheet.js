...
$(document).ready(function(){ 
	$("changecolor/index.htm").switchstylesheet( { seperator:"color"} );
});
</script>

Usage :
<a href="index.htm#" class="changecolor" title="red-color">Red</a> |
<a href="index.htm#" class="changecolor" title="green-color">Green</a> |
<a href="index.htm#" class="changecolor" title="blue-color">Blue</a>
