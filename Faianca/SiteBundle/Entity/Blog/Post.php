...
use Faianca\SiteBundle\Interfaces\Blog\PostInterface;
use Faianca\SiteBundle\Helper\FaiancaCore;

/**
 * Faianca\SiteBundle\Entity\Blog
 *
 * @ORM\Entity(repositoryClass="Faianca\SiteBundle\Entity\Blog\Repository\PostRepository")
 * @ORM\Table(name="blog")
 * @ORM\Entity
 */
class Post implements PostInterface {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Faianca\SiteBundle\Entity\Blog\Comment", mappedBy="post")
     * @ORM\JoinColumns({
     ...
     * Add comments
     *
     * @param Faianca\SiteBundle\Entity\Blog\Comment $comments
     */
    public function addComment(\Faianca\SiteBundle\Entity\Blog\Comment $comments)
    {
     ...
     * Set category
     *
     * @param Faianca\SiteBundle\Entity\Category $category
     */
    public function setCategory(\Faianca\SiteBundle\Entity\Category $category)
    {
     ...
     * Get category
     *
     * @return Faianca\SiteBundle\Entity\Category 
     */
