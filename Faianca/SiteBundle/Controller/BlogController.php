...
use Faianca\SiteBundle\Form\CommentType;
...
class BlogController extends Controller {
    ...
    public function indexAction($page)
    {
        ...
        $articles = $em->getRepository('Faianca\SiteBundle\Entity\Blog\Post')->findAll();
        
        $adapter = new ArrayAdapter($articles);
        $pager = new Pager($adapter, array('page' => $page, 'limit' => 5));
      
        return $this->render('FaiancaSiteBundle:Blog:index.html.twig', array(
            'pager' => $pager
        ));   
    }
    ...
    public function showAction($slug)
    {
        ...
        $article = $em->getRepository('Faianca\SiteBundle\Entity\Blog\Post')->findOneBySlug($slug);
       ...
       // $commentForm = $this->createForm(new CommentType(), $article);
        ...
        return $this->render('FaiancaSiteBundle:Blog:show.html.twig', array(
            'article' => $article,
